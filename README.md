...
- [Phase 2：后端入门与前后端打通](#phase-2后端入门与前后端打通) → 📄 [详细文档](./02-go-backend.md)
- [Phase 3：工程化与项目部署](#phase-3工程化与项目部署) → 📄 [详细文档](./03-deployment.md)
- [Phase 4：Agent 开发基础](#phase-4agent-开发基础) → 📄 [详细文档](./04-agent-basics.md)
- [Phase 5：实战 — 从零交付一个 Agent 应用](#phase-5实战--从零交付一个-agent-应用) → 📄 [详细文档](./05-agent-project.md)
- [持续学习的资源索引](#持续学习的资源索引)
